...
impl From<&Theme> for EditorTheme {
    fn from(t: &Theme) -> Self {
        EditorTheme {
            ...
            label_ai: t.label_ai,
            config_pointer: t.config_pointer,
            config_label_selected: t.config_label_selected,
            config_label: t.config_label,
            config_value: t.config_value,
            config_edit_bg: t.config_edit_bg,
            config_tab_active_bg: t.config_tab_active_bg,
            config_tab_active_fg: t.config_tab_active_fg,
            config_tab_inactive: t.config_tab_inactive,
            config_toggle_on: t.config_toggle_on,
            config_toggle_off: t.config_toggle_off,
            config_dim: t.config_dim,
            help_title: t.help_title,
            help_key: t.help_key,
            help_desc: t.help_desc,
